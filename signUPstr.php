...
<body style="background-color: #435EA8; ">
  ...
  <div class="col-12 d-flex" style="background-color: #c7d66d63;">
    ...
    <div style="height: 830px; padding-top: 300px;" class="col-5">
      <h1 style="color: #7c77b9; margin-left: 150px;">Регистрация</h1>
      <form  method="POST" action="signUP.php">
              ...
              <input class="from-control w-100 mt-2 inpts mns-regular" placeholder="    Email" type="email" name="email">
              <input class="from-control w-100 mt-2 inpts mns-regular" placeholder="    Пароль" type="password" name="password">
              <select name="status">
              ...
              <div class="col-4"></div>
              <div class="col-4">
                <button class="btn mns-bold bg-warning inpts mt-4">Зарегистрироваться</button>
              </div>
              <div class="col-4"></div>
            </div>
            </form>
